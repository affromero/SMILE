...
class MobileNetV2(nn.Module):
    def __init__(self, color_dim=3, num_attributes=40, input_size=224, width_mult=1.):
        ...
        layers = [conv_3x3_bn(color_dim, input_channel, 2)]
...
def mobilenetv2(mask=True, **kwargs):
    """
    ...
    if mask:
        ...
        color_dim = 3
    model = MobileNetV2(color_dim=color_dim, **kwargs)
    return model
