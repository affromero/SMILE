    ...
    def __init__(self,
        ...
        self.lines = [
            line.strip().split() for line in open(
                os.path.abspath(
                    'data/CelebA_HQ/list_attr_celeba.txt')).readlines()
        ]
        ...
        self.splits = {
            ...
            for line in open(
                os.path.abspath(
                    'data/CelebA_HQ/train_val_test.txt')).readlines()[1:]
        }
